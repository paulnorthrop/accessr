...
This package provides functions to produce accessible html and PDF documents from input R markdown files.  A main aim is to enable documents of different formats to be produced from a single R markdown source file using a single function call.  A zip file containing multiple files can be produced.  The option to print html output to (non-accessible) PDF files is also available.      
