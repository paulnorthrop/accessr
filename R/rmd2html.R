...
#'   printed to a PDF file using \code{pagedown::chrome_print}.
...
#'   \code{pagedown::chrome_print}. \code{input} cannot be passed
...
#'   \code{\link{rmd2slidy}}  for other output formats.
